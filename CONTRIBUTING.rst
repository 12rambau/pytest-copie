...
Thank you for your help improving **pytest-copie**!

**pytest-copie** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **pytest-copie** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/pytest-copie
   cd pytest-copie
...
This will install the **pytest-copie** library, together with two additional tools:
